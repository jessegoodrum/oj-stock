...
export default function Info(){
    ...
    return(
        ...
        <Card.Body>
          ...
          <Card.Text>Currently this app only works for the Chambers Bay Whole Foods in University Place Washington.</Card.Text>
        ...
        <Card.Footer className="text-muted">WholeFoodsOJ was created by Jesse Goodrum, a Whole Foods employee as a portforlio project. 2023</Card.Footer>
      </Card>
        </>
    )
}